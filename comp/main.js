...
var _asm_game = _interopRequireDefault(require("./src/asm_game"));
...
function create_challenge_grid(challengesobj) {
  ...
  for (var i = 0; i < challengesobj.challenge_count; i++) {
    document.getElementById("start_challenge" + parseInt(i, 10)).addEventListener("click", function () {
      start_game(i);
    });
  }
}
